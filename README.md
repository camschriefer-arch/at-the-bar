...
- The Feed tab is one stream of your friends' arrivals ("Bob is at Jake & Joe's"), departures ("Bob has left Jake & Joe's") and drink photos, newest first, with comments and emoji reactions on the photos. It shows accepted friends and you, nobody else — long-press a card to report a post or block its author.
