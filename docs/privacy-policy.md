---
title: At The Bar — Privacy Policy
---
...
it never collects, and what you can do about it.

Contact: **cam.schriefer@gmail.com**
...
The app asks for location permission, including background location, so that it
can notice when you arrive somewhere. Here is exactly what happens:

1. Your device reads your location and compares it, **on the device**, against a
   catalog of venues downloaded from OpenStreetMap.
2. If you have stayed within about 0.1 miles of a venue for five minutes, the
...
they are not publicly addressable on the internet.
...
- **Expo push notification service** and **Apple/Google** deliver notifications.
- **OpenStreetMap** is the source of the venue catalog. This is a one-way
  download of public venue data; nothing about you is sent to OpenStreetMap.

These providers act on our behalf and are not permitted to use your data for
their own purposes.
...
- **Delete your account**: email **cam.schriefer@gmail.com** and we will delete
  ...
  and is unaffected.
- **Access or correction**: email the address above and we will provide a copy of
  the data associated with your account, or correct it.

If you are in the EEA or UK, our lawful basis for processing this data is the
performance of our agreement with you (running the app you signed up for) and, in
the case of location, your explicit consent, which you may withdraw at any time.
If you are in California, we do not sell or share personal information as those
terms are defined by the CCPA.

## Children

At The Bar is about places that serve alcohol and is not intended for anyone
under 17. We do not knowingly collect data from children. If you believe a child
has created an account, email us and we will delete it.

## Data retention

Your status is transient — it exists only while you are checked in. Your profile,
friendships and photos are kept until you delete them or ask us to delete your
account. Unaccepted invites expire after 30 days.

## Changes to this policy

If this policy changes materially, we will update the effective date above and,
where the change affects how your location is used, tell you in the app before it
takes effect.
